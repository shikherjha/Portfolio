...
const experiences = [
  {
    ...
    org: "Intelligence Corp",
    impact: [
      "Led the design of a scalable agentic workflow processing 10k+ concurrent requests.",
      "Optimized LLM inference reducing latency by 40% using vLLM and TensorRT.",
      "Mentored a team of 4 junior engineers in distributed systems design."
    ]
  },
  {
    year: "2022",
    ...
    org: "Dataflow Inc.",
    impact: [
      "Built an automated training pipeline for computer vision models, saving 20 hrs/week.",
      "Deployed real-time fraud detection service with 99.99% uptime.",
      "Migrated legacy monolithic ML services to Kubernetes."
    ]
  },
  {
    year: "2020",
    ...
    org: "Tech Startup",
    impact: [
      "Developed high-throughput APIs in Go serving millions of DAU.",
      "Implemented caching layer with Redis improving response times by 3x.",
    ]
  }
];
...
export function JourneySection() {
  return (
    <section id="05-journey" className="w-full min-h-screen py-24 flex items-center">
